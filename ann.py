...
# Importing the dataset of categorical variable
dataset = pd.read_csv('CathegoricalData.csv')
X = dataset.iloc[:, 5:20].values # Independent Variables what I will need from you under a csv file if possible
y = dataset.iloc[:, 20].values # Dependent Variables what I will need from you under a csv file if possible
...
classifier.add(Dense(output_dim = 6, init = 'uniform', activation = 'relu', input_dim = 11)) # Activation function
